...
Calling the relevant information needed to describe extinct species. Scientific name, category (ex: threatened, endangered, extinct) and class. 
```{r}
