...
Because we are retrieving the data for multiple speceis and pages, we cna apply the map function to perform the function on each page, rather than doin it individually. This also stops the map function if the status code returned is above 200, that is to say, it cannot retrieve the page. 
```{r}
